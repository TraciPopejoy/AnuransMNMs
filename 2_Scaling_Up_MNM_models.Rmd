...
First I identify study extent

```{r}
va<-st_as_sf(map('state',c('virginia','north carolina','south carolina','georgia',
                           'florida'), fill=T, plot=F)) %>%
...
va_r<-st_rasterize(va, dx=70, dy=70) %>% #turn into a raster
