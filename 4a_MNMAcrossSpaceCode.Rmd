...
Below is the code I use to run many mechanistic niche models across the Southeastern United States region on the High Power Computer. I run it on the HPC to parallelize the code. Below is the bash script submitted to SLURM to generate MNM models. It calls two R scripts, one to run models and one to collate results. Both are described below. Because errors occur in the compilation of the microclimate model (described below), I often have to run this script multiple times to get through large chunks of points. 
...
pwd
echo "============================="
#singularity exec --bind=/fastscratch/tracidubose/AnuranMNMs /projects/arcsingularity/ood-rstudio141717-geospatial_4.1.1.sif Rscript build_bodytemp_summa$
echo "Running MNMs"
echo "============================="
...
singularity exec --bind=/fastscratch/tracidubose/AnuranMNMs /projects/arcsingularity/ood-rstudio141717-geospatial_4.1.1.sif Rscript build_bodytemp_summary_df.r
echo "============================="
echo "built bodytemp summary too"
```
...
# TerraClimate_tmax_2012.nc

#terra_climate_plus2C/TerraClimate_2c_tmax_2012.nc
